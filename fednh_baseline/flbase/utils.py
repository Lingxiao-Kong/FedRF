...
from fednh_baseline.utils import sampler, sampler_reuse, DatasetSplit, setup_seed
import numpy as np
"""
Configure Optimizer
"""
...
def setup_clients4ours(Client, trainset, testset, criterion, client_config_lst, device, client_num,**kwargs):
    """
        Client is a class constructor.
        A deepcopy is invoked such that each client has a unique model.
        **kwargs:
