...
class Server:
    def __init__(self, server_config, clients_dict, **kwargs):
        ...
        self.server_side_client = kwargs['client_cstr'](
            ...
            kwargs['global_trainset'][0],
            kwargs['global_testset'][0],
            kwargs['server_side_client_config'],
            -1,
            kwargs['server_side_client_device'],
            **kwargs)
        # TODO 这里是五个客户端
        self.server_side_clients = {}
        for cid in range(self.num_clients):
            # same initial weight
            self.server_side_clients[cid] = kwargs['client_cstr'](
            kwargs['server_side_criterion'],
            kwargs['global_trainset'][cid],
            kwargs['global_testset'][cid],
            kwargs['server_side_client_config'],
            -1,
            kwargs['server_side_client_device'],
            **kwargs)
