...
class FedRepServer(FedAvgServer):
    ...
    def run(self, **kwargs):
        ...
        for r in round_iterator:
            ...
            # print(self.server_side_client.model.state_dict()['prototype.weight'][0, :5])
            ...
            for cid in self.active_clients_indicies:
                ...
                # train head
                client.training(r, client.client_config['FedRep_head_epochs'])
                # fix head
